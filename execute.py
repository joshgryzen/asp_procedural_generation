...
def parse_atoms(symbols):
    ...
    return islands, bridges, enemies, keys, doors


# ----------------------------------------------------------
# Draw map in Tkinter
# ----------------------------------------------------------
def draw_map(islands, bridges, enemies, keys, doors):
...
def generate_map():
    ...
    print(atoms)
    island_list, bridge_list, enemy_list, key_list, door_list = parse_atoms(atoms)

    if not island_list:
        messagebox.showerror("Error", "No islands generated by ASP program.")
        return

    draw_map(island_list, bridge_list, enemy_list, key_list, door_list)
